...
# Optional snapshot import (generated by export_db_to_snapshot.py)
try:
...
if __name__ == "__main__":
    # If a snapshot file exists and imports successfully, seed from it
    if get_seed_data is not None:
        print("Using snapshot from seed_snapshot.py to seed database...")
        # Clear collections present in snapshot and insert data
        data = get_seed_data()
        # Determine which collections are present
        collections = [
            'categories', 'citizens', 'service_requests', 'comments', 'ratings', 'performance_logs'
        ]
        print("\n🗑️  Clearing existing data...")
